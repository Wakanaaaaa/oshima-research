...
export default function Word4() {
  ...
  const fetchDocumentsForWord1 = async () => {
    try {
      ...
      subcollectionSnapshot.forEach((doc) => {
        ...
        if (containsWord1 && containsWord2 && containsWord3 && containsWord4) {
  ...
  useEffect(() => {
    if (word1 && word2 && word3 && word4 && testerNumber) {
      fetchDocumentsForWord1();
    }
  }, [episodeID, word1, word2, word3, word4, testerNumber, episodeType]);
